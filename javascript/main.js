    ...
    'use strict'
     ...
     var retinaLogos = function() {
       var retina = window.devicePixelRatio > 1 ? true : false;
         if(retina) {
             $('.logo').find('img').attr( {src:'./assets/image/LogoDark.webp'} );
             $('.logo-bottom').find('img').attr( {src:'./assets/image/Logolight@2x.webp'} );
             $('.logo-h2').find('img').attr( {src:'./assets/image/LogoDark@2x.webp'} );
         }
     };       
